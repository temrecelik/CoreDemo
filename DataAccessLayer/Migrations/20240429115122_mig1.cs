...
#nullable disable
/*
Paket manager konsolda mig yaparak entites kısmında bulunan claslarımız ve içindeki sütunlara karşılık gelen değişkenler dataaccess katmanında migration klasörü altında tabloya çevrilmiş kod dosyası gelir.Mig yaparken data acces katmanını seçeriz
Migleme işleme konsola;
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutMapLocatio = table.Column<string>(type: "nvarchar(max)", nullable: false),
